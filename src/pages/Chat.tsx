...
${JSON.stringify(notes, null, 2)}
      ...
      const systemInstruction = `
        ...
        6. สำหรับข้อมูล Health Events: หากเป็นประเภท Alcohol/Smoking ให้ดูที่ IsActive (Yes=ยังทำอยู่, No=เลิกแล้ว, Never=ไม่เคย), Frequency, Quantity, EndDate เป็นหลัก ส่วนประเภทอื่นๆ (Illness, Symptom ฯลฯ) ให้ดูที่ Status (หายดีแล้ว/ยังมีอาการค้างอยู่), Severity, RelatedMedications เป็นหลัก
      ...
      <div className="p-4 border-b border-slate-200 bg-indigo-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            ...
            <option value="gemini-3-flash-preview">(20) Gemini 3 Flash Preview (ฉลาดที่ 5) (Default)</option>
            <option value="gemini-3.1-flash-lite-preview">(500) Gemini 3.1 Flash Lite Preview (ฉลาดที่ 6)</option>
